...
(
    ...
    localparam PAD8 = log2ceil(64'h1001080 - 64'h1001070); 
    localparam PAD9 = log2ceil(64'h1001090 - 64'h1001080); 
    localparam PAD10 = log2ceil(64'h10010a0 - 64'h1001090); 
    localparam PAD11 = log2ceil(64'h10010b0 - 64'h10010a0); 
    localparam PAD12 = log2ceil(64'h10010c0 - 64'h10010b0); 
    localparam PAD13 = log2ceil(64'h10010d0 - 64'h10010c0); 
    localparam PAD14 = log2ceil(64'h10010d8 - 64'h10010d0); 
    localparam PAD15 = log2ceil(64'h10010da - 64'h10010d8); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h10010da;
    ...
    // ( 0x1001040 .. 0x1001050 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 25'h1001040  && read_transaction  ) begin
    ...
    // ( 0x1001080 .. 0x1001090 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 25'h1001080   ) begin
            src_channel = 16'b0000000100000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x1001090 .. 0x10010a0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 25'h1001090   ) begin
            src_channel = 16'b0000000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x10010a0 .. 0x10010b0 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 25'h10010a0   ) begin
            src_channel = 16'b0000000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x10010b0 .. 0x10010c0 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 25'h10010b0   ) begin
            src_channel = 16'b0000000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x10010c0 .. 0x10010d0 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 25'h10010c0  && read_transaction  ) begin
            src_channel = 16'b0000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
    end

    // ( 0x10010d0 .. 0x10010d8 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 25'h10010d0   ) begin
            src_channel = 16'b0000000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x10010d8 .. 0x10010da )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 25'h10010d8   ) begin
